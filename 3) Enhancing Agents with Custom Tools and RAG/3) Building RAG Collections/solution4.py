# create a new file, rag_agent.py, to define an agent that processes prompts and returns responses
# then integrate this agent into the main script to handle user queries effectively
